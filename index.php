  ...
  <header>
    <div class="header-l">
      <div class="logo">
        ...
        <p class="logo__subtitle">Développeur Web<span class="underscore flash">_</span></p>
      </div>
  ...
  <main class="main-l">
    ...
    <section class="section-l" id="about">
      ...
      <div class="section__content">
        ...
        <p class="presentation__text">Je mets le même enthousiasme à réaliser un nouveau projet informatique qu'à guider mes clients à

      ...
      <div class="section__content section__skills">
        <div class="skill__block">
          ...
          <ul class="skill__list">
            ...
            <li class="skill__list__item">Réaliser un site dynamique en JavaScript</li>
            <li class="skill__list__item">Réaliser une interface utilisateur à l'aide d'un CMS</li>
          </ul>
        </div>
        <div class="skill__block">
          <div class="block__title">
          ...
          <ul class="skill__list">
            <li class="skill__list__item">Concevoir une base de données</li>
            <li class="skill__list__item">Concevoir des composants d'accès aux données</li>
            <li class="skill__list__item">Développer la partie back-end d'une application web</li>
            <li class="skill__list__item">Développer une application de gestion de contenu</li>
          </ul>
        </div>
      </div>
